...
const sizes = [];
const totalSpaceUsed = setSizes(d);
...
const freeSpace = diskSize - totalSpaceUsed;
const spaceToBeMade = spaceNeeded - freeSpace;

const orderedSizes = sizes.sort((a, b) => (a.size - b.size));
const dirToRemove = orderedSizes.find((a) => (a.size >= spaceToBeMade));
console.error(dirToRemove);
